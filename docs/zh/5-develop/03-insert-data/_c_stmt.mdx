...
[查看源码](https://github.com/taosdata/TDengine/blob/main/docs/examples/c/stmt_example.c)
...
[查看源码](https://github.com/taosdata/TDengine/blob/main/docs/examples/c/multi_bind_example.c)