...
import InstallOnLinux from "../../9-connector/_linux_install.mdx";
import InstallOnWindows from "../../9-connector/_windows_install.mdx";
import InstallOnMacOS from "../../9-connector/_macos_install.mdx";
import VerifyLinux from "../../9-connector/_verify_linux.mdx";
import VerifyMacOS from "../../9-connector/_verify_macos.mdx";
import VerifyWindows from "../../9-connector/_verify_windows.mdx";
...
:::tip
如果建立连接失败，大部分情况下是 FQDN 或防火墙的配置不正确，详细的排查方法请看[《常见问题及反馈》](https://docs.taosdata.com/faq)中的“遇到错误 Unable to establish connection, 我怎么办？”
