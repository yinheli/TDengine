...
export const ToServer = ()=>(<a href="./server-setup-and-management">「服务器搭建与管理」</a>);
export const ToProgram = ()=>(<a href="../tdengine-programs">「TDengine 程序」</a>);
export const ToDir = ()=>(<a href="../reference/direcTory">「目录结构」</a>);
export const ToPlatform = ()=>(<a href="../reference/supported-platform">「参考/支持平台」</a>);
export const ToCloud = ()=>(<a href="../deployment-in-cloud">「云部署」</a>);
