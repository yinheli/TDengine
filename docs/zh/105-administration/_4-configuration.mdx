...
export const ToAdapter = ()=>(<a heref="../tdengine-programs/taosadapter">「taosadapter」</a>);
export const ToKeeper = ()=>(<a heref="../tdengine-programs/taoskeeper">「taoskeeper」</a>);
export const ToIns = ()=>(<a href="../sql-language/meta">「information_schema」</a>);
