...
import FqdnSetting from "./_asset/_fqdn-setting.mdx";

export const ToInstall = ()=>(<a href="../../server-installation">「服务端安装/卸载/升级」</a>);
export const ToTaosd = ()=>(<a href="../taod-instance-management">「taosd 实例管理」</a>);
export const ToServerArchitecture = ()=>(<a href="./../../server-architecture">「服务端架构」</a>);
export const ToArchitecture = ()=>(<a href="../../../internals/cluster-architecture">「技术内幕/集群架构」</a>);
export const ToSql = ()=>(<a href="../../../sql-language/node">「SQL 手册/集群管理」</a>);
export const ToConf = ({head})=>(<a href={"../../configuration"+head}>「服务器配置」</a>);
export const ToCloud = ()=>(<a href="../../../deployment-in-cloud">「Docker 部署」</a>);
...
首节点即为配置参数 `firstEp` 所对应的节点，该节点的 taosd 应该最先启动（启动方式，请参考<ToTaosd/>）：
...
1 - 启动节点的 taosd（启动方式，请参考<ToTaosd/>）：
