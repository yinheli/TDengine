...
11. 也可以使用 taos 程序内嵌的网络连通检测功能，来验证服务器和客户端之间指定的端口连接是否通畅：[诊断及其他](../administration/diagnose/)。
...
有关 taosAdapter 组件的详细介绍请看文档：[taosAdapter](../service-and-executable/taosadapter/)
