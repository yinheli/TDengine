...
import NodeInsert from "../5-develop/03-insert-data/_js_sql.mdx";
import NodeInfluxLine from "../5-develop/03-insert-data/_js_line.mdx";
import NodeOpenTSDBTelnet from "../5-develop/03-insert-data/_js_opts_telnet.mdx";
import NodeOpenTSDBJson from "../5-develop/03-insert-data/_js_opts_json.mdx";
import NodeQuery from "../5-develop/04-query-data/_js.mdx";
...
[查看源码](https://github.com/taosdata/TDengine/blob/main/docs/examples/node/restexample/insert_example.js)
...
[查看源码](https://github.com/taosdata/TDengine/blob/main/docs/examples/node/restexample/query_example.js)
